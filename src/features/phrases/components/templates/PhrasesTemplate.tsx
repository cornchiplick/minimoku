...
import FormResetButton from "@/shared/common/FormResetButton";
import FormSelect from "@/shared/common/FormSelect";
import Icon from "@/shared/common/Icon";
import SentenceCard from "@/shared/common/SentenceCard";
import SortButton from "@/shared/common/SortButton";
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {initialPhrases.map((phrase) => (
          <div
            ...
            <div
              className="pointer-events-none absolute top-[-6px] left-[-6px] opacity-0 transition-opacity group-hover:pointer-events-auto group-hover:opacity-100"
              onClick={(e) => {
                e.stopPropagation();
                onDelete(phrase.id);
              }}>
