...
const FilterItem = ({filter}: FilterItemProps) => {
  ...
  return (
    <button
      ...
      className={`flex w-full items-center justify-between rounded-lg px-3 py-2 text-left transition-colors ${isDarkMode ? "hover:bg-gray-700" : "hover:bg-gray-100"} ${selectedFilterId === filter.id ? "bg-minimoku text-gray-700" : "text-gray-700"}`}>
