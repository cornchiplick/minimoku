const HiaraKataPage = () => {
  return (
    <div className="container flex flex-col gap-6 px-4 py-8">
      <h2 className="text-2xl font-bold">히라가나 / 카타카나 표</h2>

      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-4">
          <h3 className="text-xl font-bold">히라가나 (ひらがな)</h3>
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-gray-600">* 일부만 표시됨</p>
          </div>
        </div>

        <div className="flex flex-col gap-4">
          <h3 className="text-xl font-bold">카타카나 (カタカナ)</h3>
          <div className="flex flex-col gap-2">
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white">
                <thead>
